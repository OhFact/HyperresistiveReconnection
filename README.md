...
To run "linear.py", configure which of the 3 runs you want to do (Nx, Ny) = (64,64), (64,128),or (128,128) in your python file by changing the inputs at cfg = TearingSimConfig, and then just run on cpu in your MHX directory.
